...
var (
	...
	authorsFileHeader = "# This is the official list of github.com/blockchain-analysis-study/go-ethereum-analysis authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The github.com/blockchain-analysis-study/go-ethereum-analysis Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "github.com/blockchain-analysis-study/go-ethereum-analysis"
	}
	if startOfSentence {
		return "The github.com/blockchain-analysis-study/go-ethereum-analysis library"
	}
	return "the github.com/blockchain-analysis-study/go-ethereum-analysis library"
}
