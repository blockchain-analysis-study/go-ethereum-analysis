...
[![Travis](https://travis-ci.org/ethereum/github.com/go-ethereum-analysis.svg?branch=master)](https://travis-ci.org/ethereum/github.com/go-ethereum-analysis)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/ethereum/github.com/go-ethereum-analysis

    go install github.com/ethereum/github.com/go-ethereum-analysis/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/ethereum/github.com/go-ethereum-analysis`.

Most likely you will be working from your fork of `github.com/go-ethereum-analysis`, let's say from `github.com/nirname/github.com/go-ethereum-analysis`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/github.com/go-ethereum-analysis.git $GOPATH/src/github.com/ethereum/github.com/go-ethereum-analysis
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/ethereum/github.com/go-ethereum-analysis/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/ethereum/github.com/go-ethereum-analysis/wiki/Code-Review-Guidelines).
...
The github.com/go-ethereum-analysis library (i.e. all code outside of the `cmd` directory) is licensed under the
[GNU Lesser General Public License v3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html), also
included in our repository in the `COPYING.LESSER` file.

The github.com/go-ethereum-analysis binaries (i.e. all code inside of the `cmd` directory) is licensed under the
